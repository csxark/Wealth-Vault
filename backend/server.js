...
import forensicAuditRoutes from "./routes/forensic-audit.js";
...
import anomalyDetector from "./jobs/anomalyDetector.js";
...
app.use("/api/forensic-audit", userLimiter, forensicAuditRoutes);
