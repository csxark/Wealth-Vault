...
export const Profile: React.FC = () => {
  ...
  if (loading) {
    return (
      <div className="flex items-center justify-center min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-cyan-900 dark:bg-white">
  ...
  if (!profile) {
    return (
      <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-cyan-900 dark:bg-white p-4 flex items-center justify-center">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br dark:from-slate-900 via-slate-800 to-cyan-900 bg-white p-4 sm:p-6 lg:p-8">
      <div className="max-w-7xl mx-auto space-y-6">
        
        {/* Dev Mode Badge */}
        {isDevMode && (
          <div className="dark:bg-yellow-500/10 border bg-slate-200 border-yellow-500/30 rounded-xl p-4 backdrop-blur-sm">
        ...
        {/* Header Card */}
        <div className="bg-white dark:bg-slate-900/80 backdrop-blur-xl rounded-2xl shadow-2xl border border-slate-200 dark:border-cyan-500/20 overflow-hidden">
  
        {/* Background Pattern */}
        <div className="h-32 bg-gradient-to-r 
          from-cyan-400/20 via-blue-400/20 to-purple-400/20
          dark:from-cyan-500/20 dark:via-blue-500/20 dark:to-purple-500/20 
          ...
          <div className="flex flex-col sm:flex-row items-center sm:items-end gap-6 mb-6">
            ...
            <div className="relative">
              <div className="w-32 h-32 
                ...
                shadow-xl border-4 border-white dark:border-slate-900">
            ...
            <div className="flex-1 text-center sm:text-left">
              ...
              <div className="flex items-center justify-center sm:justify-start gap-2 text-cyan-600 dark:text-cyan-400 mb-3">
                ...
                <>
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 px-6 py-3 rounded-xl
                      ...
                      font-semibold hover:bg-slate-300 dark:hover:bg-slate-600 transition-all">
                    <X className="w-5 h-5" />
                    Cancel
                  </button>
                </>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        {/* Income */}
        <div className="bg-white dark:bg-slate-900/70 backdrop-blur-xl rounded-xl p-6 
          ...
          <div className="flex items-center justify-between mb-3">
            <div className="bg-green-500/10 p-3 rounded-lg">
              <IndianRupee className="h-6 w-6 text-green-500 dark:text-green-400" />
            </div>
        ...
        <div className="bg-white dark:bg-slate-900/70 backdrop-blur-xl rounded-xl p-6 
          ...
          <div className="flex items-center justify-between mb-3">
            <div className="bg-cyan-500/10 p-3 rounded-lg">
              <TrendingUp className="h-6 w-6 text-cyan-500 dark:text-cyan-400" />
            </div>
            <span className="text-xs font-medium text-slate-500 dark:text-slate-400 uppercase tracking-wider">
              Savings Rate
            </span>
          ...
          <p className="text-sm text-slate-500 dark:text-slate-400">Of income</p>
        </div>
      </div>
      ...
      <div className="bg-white dark:bg-slate-900/70 backdrop-blur-xl rounded-2xl shadow-2xl 
        ...
        <div className="px-6 sm:px-8 py-6 border-b border-slate-200 dark:border-slate-700/50">
          <h2 className="text-2xl font-bold text-slate-900 dark:text-white flex items-center gap-3">
            <UserIcon className="h-6 w-6 text-cyan-500 dark:text-cyan-400" />
            Personal Information
          </h2>
        </div>
            ...
            return (
              <div key={field.key} className="group">
                <label className="flex items-center gap-2 text-sm font-semibold 
                  text-cyan-600 dark:text-cyan-400 mb-2 uppercase tracking-wider">
                ...
                {isEditing ? (
                  <input
                    ...
                    className="w-full px-4 py-3 rounded-xl
                      border border-slate-300 dark:border-cyan-500/30
                  ...
                  <div className="px-4 py-3 rounded-xl
                    ...
                    group-hover:border-cyan-400 dark:group-hover:border-cyan-500/30
                    transition-all">
