...
import { BarChart3, MessageCircle, Target, Upload, User, PieChart, Receipt, Calculator } from 'lucide-react';
...
const navigation = [
  ...
  { id: 'tax-center', name: 'Tax Center', icon: Calculator, path: '/tax-center' },
